...
/**
 * Coquille de l'app (style Anybuddy) : 4 onglets (Recherche, Matchs Publics,
 * Discussions, Profil) + la fiche club "Réserver/Infos" en surimpression.
 * Données fictives — base des écrans connectés à Supabase (Phase 1).
 */
